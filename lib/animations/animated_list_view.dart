...
class AnimatedListView extends StatelessWidget {
  ...
  const AnimatedListView({
    ...
    this.offset = 50.0,
    this.animationType = ListAnimationType.fade,
    this.padding,
  });
